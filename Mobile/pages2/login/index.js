...
export default function Login({ navigation }) {
    ...
    const autenticar = () => {
        ...
        fetch('http://10.87.207.9:7000/login', {
            "method":"POST",
            "headers": {
    ...
    const cadastrar = () => {
        ...
        return (
            <View style={style.body}>
                {/* <Image style={style.brilho} source={require("../../assets/brilho.png")}></Image> */}
                ...
                <TextInput style={style.input} value={email} onChangeText={setEmail} placeholder={"Email"} placeholderTextColor={'silver'}/>
                <TextInput style={style.input} value={senha} onChangeText={setSenha} placeholder={"Senha"} placeholderTextColor={'silver'} secureTextEntry={true}/>
