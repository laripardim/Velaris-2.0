...
export default function Leitura({ navigation, route }) {
    ...
    useEffect(() => {
        ...
        fetch('http://192.168.0.4:7000/leitura', {
            "method": "GET",
            "headers": {
            ...
            <View style={style.scroll}>
                <ScrollView>
                    ...
                    <TouchableOpacity onPress={speak}>
                        <Text style={{color: 'white', textAlign: 'center', fontSize: 18}}>Ouça o Livro:</Text>
                    ...
                    <TouchableOpacity onPress={() => { navigation.navigate("Home")}}>
                        <Text style={{color: "silver", marginTop: 30, textAlign: 'center', fontSize: 18, borderWidth: 3, borderColor: 'darkmagenta', height: 30, width: 150, justifyContent: "center", alignSelf: 'center'}}>Finalizar leitura</Text>
                    </TouchableOpacity>
