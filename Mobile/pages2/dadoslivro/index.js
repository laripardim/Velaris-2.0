...
export default function DadosLivro({ navigation, route }) {
    const {titulo, capa, genero, sinopse, comentario, texto} = route.params
    ...
    useEffect(() => {
        fetch('http://10.87.207.23:7000/dados', {
            "method": "GET",
            "headers": {
        ...
        <View style={style.body}>
            <View style={style.scroll}>
                <ScrollView>
                    ...
                    <TouchableOpacity onPress={() => { navigation.navigate("Leitura", {"texto":texto})}}>
